    ...
    <div className="min-h-screen bg-[#2D0B5A] flex flex-col items-center">
      ...
      <div className="flex-1 w-full bg-white rounded-t-[48px] px-8 py-10 shadow-[0_-15px_50px_rgba(0,0,0,0.4)] relative z-10">
        ...
        <div className="flex flex-col items-start w-40">
          <div className="relative mb-5 shadow-[0_15px_40px_rgba(0,0,0,0.2)] rounded-2xl overflow-hidden">
            <img 
              src={URL_CAPA_TEMPO} 
          ...
          <Link href="/reader" className="w-full bg-[#2D0B5A] text-[#FFD700] py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-transform">
